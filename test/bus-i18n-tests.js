 ...
 * молча отрывает перевод: тест собирает все tr('…') / N('…') из ui.html, ui-logic.js, cron.js, ui.js и русские тексты статичной
...
function collectKeys(SCRIPTS) {
  ...
  for (const name of ['ui.html', 'ui-logic.js', 'cron.js', 'ui.js']) {
